...
export default class TalentMatching extends React.Component {
    ...
    //loadJobs(data) { // url: 'http://talenttservice.azurewebsites.net/listing/listing/getEmployerJobs',
        
    //loadSelectedJob(data) url: 'http://talenttservice.azurewebsites.net/listing/listing/getJobForTalentMatching',

    //loadTalentList()  url: 'http://talentpservice.azurewebsites.net/profile/profile/getTalentList',

    //loadTalentFilterList() //url: 'http://talentpservice.azurewebsites.net/profile/profile/getTalentListFilter',

    //loadEmployerFilterList() //url: 'http://talentpservice.azurewebsites.net/profile/profile/getEmployerListFilter',


    // loadEmployerList() // url: 'http://talentpservice.azurewebsites.net/profile/profile/getEmployerList',
    //loadSuggestionList   url: 'http://talentpservice.azurewebsites.net/profile/profile/getSuggestionList',

   // saveCompanyTalents()   url: 'http://talentpservice.azurewebsites.net/profile/profile/addTalentSuggestions',
     

    //saveJobTalents()    url: 'http://talentpservice.azurewebsites.net/profile/profile/addTalentSuggestions',
