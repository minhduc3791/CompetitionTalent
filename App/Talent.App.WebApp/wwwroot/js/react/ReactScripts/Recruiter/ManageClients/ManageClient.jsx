...
export default class ManageClient extends React.Component {
    ...
    // loadData url: 'http://talentpservice.azurewebsites.net/profile/profile/getClientList',
    //deleteClient  url: 'http://talentiservice.azurewebsites.net/authentication/authentication/deactivateClientAccount?id=' + clientId,
